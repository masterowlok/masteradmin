...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const [subcategoryModule,setsubCategoryModule] = useState([])
  const [notificationModule,setnotificationModule] = useState([])
  const [manageUserModule,setmanageUserModule] = useState([])
  ...
  useEffect(() => {
    ...
    setroleData(parseData)
    const category = parseData.filter((item,index)=>{
      return (item.module === 'Category') && item
    })
    setCategoryModule(category[0])
    const subcategory = parseData.filter((item,index)=>{
      return (item.module === 'Sub Category') && item
    })
    setsubCategoryModule(subcategory[0])
    const notification = parseData.filter((item,index)=>{
      return (item.module === 'Notification') && item
    })
    setnotificationModule(notification[0])
    const manageUser = parseData.filter((item,index)=>{
      return (item.module === 'Manage User') && item
    })
    setmanageUserModule(manageUser[0])
  }, [])
  ...
  //   const getData = async()=>{
  //     await axios.get(`${REACT_APP_API_PORT}api/admin/role/rolelistbyname/${getUserType}`,{
  //       headers: {
    ...
    <>
{
      ...
      <div className='no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear'>
        ...
        <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
          ...
          <div>
            ...
            {
              (manageUserModule?.status ==='Active' || auth === 'admin') &&
        ...
        >
          ...
          />
                      ...
                      >
                        <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
                        {
                          (manageUserModule?.create ==='Active' || auth === 'admin') &&
                        ...
                        {
                          (manageUserModule?.read ==='Active' || auth === 'admin') &&
              ...
              {/* manage category */}
              {
                (categoryModule?.status === 'Active' || auth === 'admin') &&
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
                        {
                          (categoryModule?.create === 'Active' || auth === 'admin') &&
                          <li>
                            <NavLink
                              to='/category/add'
                              className={({ isActive }) =>
                         ...
                         {
                          (categoryModule?.read === 'Active' || auth === 'admin') &&
              ...
              {/* manage subcategory */}
              {
                (subcategoryModule?.status === 'Active' || auth === 'admin') &&
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
                        {
                          (subcategoryModule?.create === 'Active' || auth === 'admin') &&
                        ...
                        {
                          (subcategoryModule?.read === 'Active' || auth === 'admin') &&
              ...
              {
                (notificationModule?.status === 'Active' || auth === 'admin') &&
             
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/notification' || pathname.includes('notification')
                }
              >
                {(handleClick, open) => {
                  return (
        ...
        >
          ...
          />
             ...
             <SidebarLinkGroup
                activeCondition={
                  pathname === '/subscription' || pathname.includes('subscription')
                }
              >
                {(handleClick, open) => {
                  return (
  ...
  <SidebarLinkGroup
                activeCondition={
                  pathname === '/coupon' || pathname.includes('coupon')
                }
              >
                {(handleClick, open) => {
                  return (
            ...
            <SidebarLinkGroup
                activeCondition={
                  pathname === '/managepayment' || pathname.includes('managepayment')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/managepayment' ||
                            pathname.includes('managepayment')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault()
                      ...
                      >
                        ...
                        <li>
                            <NavLink
                              to='/managepayment/payment-credential'
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
