...
const DummyUserList = (props) => {
  ...
  const getUserList = async () => {
    try {
      setisLoading(true)
        const res=await axios.get(`${REACT_APP_API_PORT}api/admin/user/list`,
        {
          headers: {
                ...
                <div className="data-table-common data-table-one max-w-full overflow-x-auto">
                  <div className="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                    ...
                    <div className="datatable-container">
                      <table
                        className="datatable-table table w-full table-auto"
                        id="dataTableOne"
                      >
                        <thead>
                          <tr>
                            ...
                            <th
                              data-sortable="true"
                              style={{ width: "13.486370157819225%" }}
                            >
                              <a href="#" className="datatable-sorter">
                                <div className="flex items-center gap-1.5">
                                  <p>Position</p>
                            ...
                            <th
                              data-sortable="true"
                              style={{ width: "10.616929698708752%" }}
                            >
                              <a href="#" className="datatable-sorter">
                                <div className="flex items-center gap-1.5">
                                  <p>BDay</p>
                            ...
                            <th
                              data-sortable="true"
                              style={{ width: "25.538020086083215%" }}
                            >
                              <a href="#" className="datatable-sorter">
                                <div className="flex items-center gap-1.5">
                                  <p>Email/Phone</p>
                            ...
                            <th
                              data-sortable="true"
                              style={{ width: "14.634146341463413%" }}
                            >
                              <a href="#" className="datatable-sorter">
                                <div className="flex items-center gap-1.5">
                                  <p>Status</p>
                        ...
                        <tbody>
                          ...
                          <tr data-index={9}>
                            <td>Elissa Stroman/164</td>
                            <td>Designer</td>
                            <td>25 Nov, 2000</td>
                            <td>Elissa@gmail.com</td>
                            <td>Block A, Demo Park</td>
                            <td>Part-time</td>
                          </tr>
                        </tbody>
                      ...
                      >
                        <thead>
                          <tr>
                            <th
                              data-sortable="true"
                              style={{ width: "21.061093247588424%" }}
                            >
                              <a href="#" className="datatable-sorter">
                            ...
                            <th
                              data-sortable="true"
                              style={{ width: "15.112540192926044%" }}
                            >
                              <a href="#" className="datatable-sorter">
                                <div className="flex items-center justify-between gap-1.5">
                                  <p>Position</p>
                            ...
                            <th
                              data-sortable="true"
                              style={{ width: "16.559485530546624%" }}
                            >
                              <a href="#" className="datatable-sorter">
                                <div className="flex items-center justify-between gap-1.5">
                                  <p>Office</p>
                            ...
                            <th
                              data-sortable="true"
                              style={{ width: "18.327974276527332%" }}
                            >
                              <a href="#" className="datatable-sorter">
                                <div className="flex items-center justify-between gap-1.5">
                                  <p>Start Date</p>
                            ...
                            <th
                              data-sortable="true"
                              style={{ width: "18.488745980707396%" }}
                            >
                              <a href="#" className="datatable-sorter">
                                <div className="flex items-center justify-between gap-1.5">
                                  <p>Salary</p>
...
setapiIsLoading(false)
  ...
  // useEffect(() => {
  //   const auth =localStorage.getItem('jwtoken')
  //   if(auth){
  //     navigate('/Dashboard')
  //   }
  // }, [])
