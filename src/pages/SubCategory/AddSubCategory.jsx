...
const validate = yup.object({
  ...
  //   .array()
  //   .min(1, "select at least 1 file and Maximum Size 1 Mb allowed"),
  categoryId:yup.string().required("Category name required"),
  name: yup.string().min(2).max(25).required("Sub Category name required"),
...
return(
    <option value={val._id}>{val.category_name}</option>
                          ...
                          <ErrorMessage name="categoryId" render={renderError} />
                        </div>
