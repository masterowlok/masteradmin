          ...
          <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div className="h-[calc(100vh-186px)] overflow-hidden sm:h-[calc(100vh-174px)]">
              <div className="h-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark lg:flex">
                <div className="false fixed top-22.5 bottom-0 z-999 flex w-[230px] -translate-x-[120%] flex-col rounded-md border border-stroke bg-white dark:border-strokedark dark:bg-boxdark lg:static lg:w-1/5 lg:translate-x-0 lg:border-none">
                  <button className="false absolute -right-20 z-99999 block rounded-md border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden">
                    <svg
                      ...
                      <tbody className="block h-full max-h-full overflow-auto py-4">
                        <tr className="flex cursor-pointer items-center hover:bg-whiten dark:hover:bg-boxdark-2">
                          ...
                          <td className="hidden w-3/5 p-4 xl:block">
                            <p>
                              Some note &amp; Lorem Ipsum available alteration
                              in some form.
                            </p>
                          </td>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <nav>
                <ol className="flex items-center gap-2">
                  ...
                  <li className="font-medium text-primary">Tabs</li>
                </ol>
              </nav>
            </div>
            <div className="flex flex-col gap-9">
              <div className="rounded-sm border border-stroke bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="mb-7.5 flex flex-wrap gap-3 rounded-lg border border-stroke py-3 px-4 dark:border-strokedark">
                  <a
                    className="rounded-md bg-primary py-3 px-4 text-sm font-medium text-white hover:bg-primary hover:text-white dark:hover:bg-primary md:text-base lg:px-6"
                    href="/ui/tabs"
                  >
                    Home
                  </a>
                  <a
                    className="rounded-md bg-gray py-3 px-4 text-sm font-medium text-black hover:bg-primary hover:text-white dark:bg-meta-4 dark:text-white dark:hover:bg-primary md:text-base lg:px-6"
                    href="/ui/tabs"
                  >
                    About Us
                  </a>
                ...
                <div>
                  ...
                  <div className="hidden leading-relaxed">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Officia nisi, doloribus nulla cumque molestias corporis
                    eaque harum vero! Quas sit odit optio debitis nulla
              ...
              <div className="rounded-sm border border-stroke bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="mb-6 flex flex-wrap gap-5 border-b border-stroke dark:border-strokedark sm:gap-10">
                  <a
                    className="border-b-2 border-primary py-4 text-sm font-medium text-primary hover:text-primary md:text-base"
                    href="/ui/tabs"
                  >
                    Profile
                  </a>
                  <a
                    className="border-b-2 border-transparent py-4 text-sm font-medium hover:text-primary md:text-base"
                    href="/ui/tabs"
                  >
                    Password
                  </a>
                ...
                <div>
                  ...
                  <div className="hidden leading-relaxed">
                    ...
                    corporis eaque harum vero! Quas sit odit optio debitis nulla
                    quisquam, dolorum quaerat animi iusto quod.
                  </div>
                </div>
              </div>
