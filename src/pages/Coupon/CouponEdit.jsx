...
const getSingleUser=async()=>{
  ...
  const validate = yup.object({
    ...
    code: yup.string().min(2).max(50).required("Coupon code required"),
    expdate: yup.string().min(2).max(50).required("Expire date required"),
    amount: yup
      .string()
      .required("amount required"),
      numofuser: yup
      .string()
      .required("number of user required"),
  ...
  const handleSubmit = async ( code, numofuser, amount, expdate, currency) => {
...
console.log({
    ...
    await axios
      .post(`${REACT_APP_API_PORT}api/admin/coupon/update`, {
        couponId:id,
        coupon_code: code,
        usage_limit: numofuser,
        expiry_date: expdate,
    ...
    <>
      <DefaultLayout>
        ...
        <div className="mx-auto max-w-270">
          <Breadcrumb pageName="Update Coupon" />
          <Formik
            initialValues={{
              code: data.coupon_code,
              numofuser: data.usage_limit,
              amount: data.amount,
            //   popular: "",
            ...
            console.log(values)
            const { code, numofuser, amount, expdate, currency}=values
            //   setFormData(values);
              handleSubmit(code, numofuser, amount, expdate, currency);
            }}
          >
                    ...
                    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        ...
                        Applied Number Of Users
                            ...
                            <div className="relative">
                              ...
                              <Field
                                ...
                                name="numofuser"
                                // id='fullName'
                                placeholder="Enter Nuber of User"
                                // defaultValue="Devid Jhon"
                              />
                            </div>
                            <ErrorMessage name="numofuser" render={renderError} />
                          </div>
                      ...
                      <option value=''>role3</option>
                        ...
                        <div className="mb-5.5">
                            ...
                            <ErrorMessage name="expdate" render={renderError} />
                          </div> 
